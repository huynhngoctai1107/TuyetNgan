    ...
    ?>
        <form class="cs" method="post" action=".././dao/nguoidung_xuli.php?makh=<?php echo $_GET['makh'] ?>">
            ...
            <div class="chinhsua">
                ...
                <br><br>
                <h6>Trạng thái </h6>
                <select name="trang_thai" style="width: 70%; margin-left: 15%; height: 40px;">
                ...
                <select name="vai_tro" style="width: 70%; margin-left: 15%; height: 40px;">
                ...
                <button class="nut12" type="submit" name="sua">Chỉnh Sửa</button>
