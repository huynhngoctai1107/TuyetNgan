  ...
  <div class="limiter" >
      <div class="chua" style="text-align: center; font-size: 30px; color: #696763 !important; height: auto;">
          <?php
            echo $thongbao;
            ?>
      </div>
          ...
          <div class="wrap-login100">
              <form class="login100-form validate-form" action="" method="POST">
                  ...
                  <div class="container-login100-form-btn">
                      <button type="submit" name="quenmk" class="login100-form-btn">
                          submit
                      </button>
                  </div>
